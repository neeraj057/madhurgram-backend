...
public class FeedbackServiceImpl implements FeedbackService {
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<CustomerFeedbackDTO> getFeedbacks(Pageable pageable) {
        log.info("Admin request: fetch paginated customer feedback records. page={}, size={}", pageable.getPageNumber(), pageable.getPageSize());
        Page<CustomerFeedback> feedbacks = feedbackRepository.findAllByOrderByCreatedAtDesc(pageable);
