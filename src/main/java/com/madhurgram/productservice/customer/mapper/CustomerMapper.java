package com.madhurgram.productservice.customer.mapper;

import com.madhurgram.productservice.customer.dto.*;
...
public class CustomerMapper {
    ...
    public CustomerHistoryDTO toHistoryDTO(String phone, List<Order> orders) {
        ...
        BigDecimal total = history.stream().map(o -> o.totalAmount()).reduce(BigDecimal.ZERO, BigDecimal::add);
