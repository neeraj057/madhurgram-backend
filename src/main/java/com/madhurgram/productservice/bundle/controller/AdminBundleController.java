...
public class AdminBundleController {
    ...
    @PutMapping("/api/v1/admin/bundles/{id}")
    ...
    @PatchMapping("/api/v1/admin/bundles/{id}/toggle")
    ...
    @DeleteMapping("/api/v1/admin/bundles/{id}")
    ...
    @GetMapping("/api/v1/admin/footer-mode")
    ...
    @PutMapping("/api/v1/admin/footer-mode")
    ...
    @PostMapping("/api/v1/admin/bundles/generate-copy")
